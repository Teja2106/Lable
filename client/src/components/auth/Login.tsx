...
export default function Login() {
  return (
    ...
    <button type="button" className="w-full flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md hover:bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors duration-300">
      ...
      <div className="mt- text-sm text-gray-600 dark:text-gray-300 text-center">
        <p>or with email</p>
      </div>
      <form action="#" method="POST" className="space-y-4">
        ...
        <div>
          <button type="submit" className="w-full bg-black text-white  dark:bg-slate-200  dark:text-black font-semibold text-lg dark:hover:text-white p-2 rounded-md hover:bg-blue-800 focus:outline-none focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">login</button>
        </div>
      </form>
