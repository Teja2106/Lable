...
const formSchema = z.object({
  email: z.string().email('Enter your email ID.'),
            ...
            >
              <div className="max-w-xl w-full space-y-4">
                ...
                <form method="POST" className="space-y-4" onSubmit={handleSubmit(onSubmit) }>
                  ...
                  <div>
                    <button type="submit" disabled={ isSubmitting } className="w-full bg-black text-white  dark:bg-slate-200  dark:text-black font-semibold text-lg dark:hover:text-white p-2 rounded-md hover:bg-blue-800 focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">{ isSubmitting ? 'Sending OTP...' : 'Send OTP' }</button>
                  </div>
                </form>
