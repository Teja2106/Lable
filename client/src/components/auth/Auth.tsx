    ...
    <div>
      ...
      <div className="relative min-h-96  grid bg-white dark:bg-gray-950 ">
        <div className="flex flex-col md:col-1 sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 h-auto">
          <div
            className="relative sm:w-1/2 xl:w-3/5  h-full hidden md:flex flex-auto items-center justify-center p- overflow-hidden  text-black dark:text-white bg-no-repeat bg-cover relative" style={{backgroundColor: "#fcdf03"}} >
