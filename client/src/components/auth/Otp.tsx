          ...
          <div className="w-full bg-gray-100 dark:bg-gray-800  lg:w-1/2 flex items-center rounded-xl justify-center">
            <div className="max-w-md w-full p-6">
              ...
              <form action="#" method="POST" className="space-y-4">
                ...
                <div className='mt-8'>
                  <button type="submit" className="w-full bg-black dark:bg-slate-600  text-white  p-2 rounded-md hover:bg-blue-800 focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Get OTP</button>
                </div>
              </form>
