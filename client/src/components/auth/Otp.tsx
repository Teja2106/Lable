    ...
    <button type="button" className="w-full flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md hover:bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors duration-300">
      ...
      <form action="#" method="POST" className="space-y-4">
        ...
        <div>
          ...
          <input type="text" id="email" name="email" placeholder="example@email.com" className="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"/>
        </div>
        
       
        <div className='mt-8'>
          <button type="submit" className="w-full bg-black dark:bg-slate-600  text-white  p-2 rounded-md hover:bg-blue-800 focus:outline-none focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Get OTP</button>
        </div>
      </form>
      <div className="mt-4 text-sm text-gray-600 dark:text-gray-400 text-center">
        <p>Don't have an account? <a href="/auth/signup" className="text-black dark:text-white hover:underline">Create now</a>
        </p>
      </div>
    </div>
  </div>
